...
**Service:** `bff` · **Port:** 3000 · **Owner:** @mia-care/inogen-field-services

## What it does
Backend-for-frontend. Aggregates devices-api and maintenance-api.
...
|---|---|---|
| Pod not Ready | `kubectl logs deploy/bff` | verify upstream/env vars, restart pod |
