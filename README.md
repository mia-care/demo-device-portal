# Inogen — Device Maintenance Portal

A field-service portal for managing the maintenance lifecycle of **Inogen portable oxygen concentrators (POCs)**: fleet inventory, filter & sieve-bed replacement schedules, battery health, and service tickets.
